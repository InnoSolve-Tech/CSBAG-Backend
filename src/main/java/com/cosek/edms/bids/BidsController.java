...
public class BidsController {
    ...
    @PostMapping("/create")
    public ResponseEntity<Bids> createBid(@RequestBody Bids bidRequest) {
        Bids savedBid = bidsService.saveBid(bidRequest);
...
//        bids.setUserId(userId);  // if `responsible_user` is stored as String
